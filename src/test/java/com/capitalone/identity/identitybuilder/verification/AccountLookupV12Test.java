...
@CamelSpringBootContextAwareTest(contextConfigClasses = AccountLookupV12Test.ContextConfig.class,
...
public class AccountLookupV12Test implements PolicyTestSupportExchange {
  ...
  public static class ContextConfig {
    ...
    CamelContext createCamelContext() throws Exception {
      ...
      CamelContextTestUtil.loadProcessXml("account_lookup_1.2.xml", camelContext);
      ...
      final String ignoredEndpointsPattern = "direct:headerUtil|" +
          "domain:/verification/barcode_retrieve/1.1|" +
    ...
    ProducerTemplate createPolicyProducerTemplate(final CamelContext camelContext) {
      ...
      producerTemplate.setDefaultEndpointUri("policy:account_lookup_1.2");
    ...
    ProducerTemplate createSchemaProducerTemplate(final CamelContext camelContext) {
      final ProducerTemplate producerTemplate = camelContext.createProducerTemplate();
      producerTemplate.setDefaultEndpointUri("direct:account_lookup_1.2-schema");
      return producerTemplate;
    }
    ...
    private static final String barcodeRetrieve_addressLine1 = "addressLine1Value";
    private static final String barcodeRetrieve_addressLine2 = "addressLine2Value";
    private static final String barcodeRetrieve_city = "cityValue";
    private static final String barcodeRetrieve_postalCode = "postalCodeValue";
    private static final String barcodeRetrieve_stateCode = "stateCodeValue";
    ...
    private static final String barcodeRetrieve_issueDate = "2018-10-16";
    private static final String barcodeRetrieve_expirationDate = "2050-10-16";
    private static final String barcodeRetrieve_replacementDate = "2019-10-16";
    private static final String barcodeRetrieve_badDate = "InvalidDate";

    // Information returned from account_lookup_1.2_GovIdBarcode.dmn
    ...
    // Information returned from account_lookup_1.2_AccountLookup--.dmn
    ...
    // Information returned from account_lookup_1.2_MatchingStatusCheck.dmn
    ...
    // Data files
    private static final String SCHEMA = "data/account_lookup/account_lookup_1.2_schema.json";
    private static final String HEADERUTIL = "data/account_lookup/account_lookup_1.2_headerUtilResponse.json";
    private static final String BARCODERETRIEVE = "data/account_lookup/account_lookup_1.2_barcodeRetrieveResponse.json";
    private static final String BARCODERETRIEVE_INVALID = "data/account_lookup/account_lookup_1.2_barcodeRetrieveResponse_Invalid.json";
    private static final String BARCODERETRIEVE_ERROR = "data/account_lookup/account_lookup_1.2_barcodeRetrieveResponse_Error.json";
    private static final String MATCHING = "data/account_lookup/account_lookup_1.2_matchingResponse.json";
    private static final String MATCHING_ERROR = "data/account_lookup/account_lookup_1.2_matchingResponse_Error.json";

    // Endpoint Responses ----------------------------------------------------------------------------------------------

    private Map<String, Object> headerUtilResponse(ArrayList<String> customerReferenceIds) throws IOException {
        String json = Resources.toString(Resources.getResource(HEADERUTIL), Charsets.UTF_8);
        Map<String, Object> jsonMap = jsonToMap(json);

        Map<String, Object> govtIdRequest = (Map<String, Object>) jsonMap.get("govtIdRequest");
        ...
        jsonMap.put("govtIdRequest", govtIdRequest);

        jsonMap.put("customerReferenceIds", customerReferenceIds);

        return jsonMap;
    }

    private Map<String, Object> barcodeRetrieveResponse(barcodeRetrieveResponses responseToggle, String expirationDate, String issueDate, String replacementDate) throws IOException {
        ...
        Map<String, Object> address = (Map<String, Object>) documentData.get("address");
        address.put("addressLine1", barcodeRetrieve_addressLine1);
        address.put("addressLine2", barcodeRetrieve_addressLine2);
        address.put("city", barcodeRetrieve_city);
        address.put("postalCode", barcodeRetrieve_postalCode);
        address.put("state", barcodeRetrieve_stateCode);
        documentData.put("address", address);
        ...
        switch (responseToggle) {
            case FOUND_ID:
                ...
                biographic.put("issueDate",issueDate);
                biographic.put("replacementDate",replacementDate);
                break;
            case NULL_DATES:
                biographic.put("expirationDate",null);
                biographic.put("issueDate",null);
                biographic.put("replacementDate",null);
                break;
        }
    ...
    private void createHeaderUtilMock(Map<String, Object> HeaderUtilResponse) {
        MockEndpoint mockHeaderUtilEndpoint = TestUtils.mockEndpoint(camelContext, "mock:direct:headerUtil");
        mockHeaderUtilEndpoint.whenAnyExchangeReceived(exchange -> {
            exchange.getIn().setHeader("unitTestHeadersHeaderUtil", exchange.getIn().getHeaders().toString());
            exchange.getIn().setHeader("request", HeaderUtilResponse);
            exchange.getIn().setBody(HeaderUtilResponse);
        });
    }
    ...
    public void testOneCustomer_InvalidBarcode_ExitsAt_RouteComplete() throws IOException {
        createHeaderUtilMock(headerUtilResponse(post_customerReferenceId));
        createBarcodeRetrieveMock(barcodeRetrieveResponse(barcodeRetrieveResponses.INVALID_BARCODE, barcodeRetrieve_expirationDate, barcodeRetrieve_issueDate, barcodeRetrieve_replacementDate));
    ...
    public void testOneCustomer_ExitsAt_BarcodeRetrieve_Exception() throws IOException {
        createHeaderUtilMock(headerUtilResponse(post_customerReferenceId));
        createBarcodeRetrieveErrorMock(barcodeRetrieveResponse(barcodeRetrieveResponses.ERROR_RESPONSE, barcodeRetrieve_expirationDate, barcodeRetrieve_issueDate, barcodeRetrieve_replacementDate));
    ...
    public void testOneCustomer_ExitsAt_Matching_Exception() throws IOException {
        createHeaderUtilMock(headerUtilResponse(post_customerReferenceId));
        createBarcodeRetrieveMock(barcodeRetrieveResponse(barcodeRetrieveResponses.FOUND_ID, barcodeRetrieve_expirationDate, barcodeRetrieve_issueDate, barcodeRetrieve_replacementDate));
        ...
        checkInitialSetup(post_customerReferenceIdA);
        checkValuesPassedTo_BarcodeRetrieve();
        checkAddress_Values(barcodeRetrieve_addressLine1, barcodeRetrieve_addressLine2, barcodeRetrieve_city, barcodeRetrieve_postalCode, barcodeRetrieve_countryCode, barcodeRetrieve_stateCode);
        ...
        checkValuesPassedTo_DMNAccountLookup("Default", barcodeRetrieve_expirationDate, barcodeRetrieve_issueDate, barcodeRetrieve_replacementDate);
    ...
    public void testTwoCustomers_FullRun_DefaultDMN_GoodDates() throws IOException, InterruptedException {
        ...
        createHeaderUtilMock(headerUtilResponse(post_customerReferenceIds));
        createBarcodeRetrieveMock(barcodeRetrieveResponse(barcodeRetrieveResponses.FOUND_ID, barcodeRetrieve_expirationDate, barcodeRetrieve_issueDate, barcodeRetrieve_replacementDate));
        createDmnGovIdBarcodeMock(dmnGovIdBarcodeResponse(govidBarcode_routeGA));
        createDmnAccountLookupMock(dmnAccountLookupResponse());
    ...
    private void checkInitialSetup(String customerReferenceIds) {
        ...
        Assertions.assertTrue(exchange.getMessage().getHeader("unitTestHeadersHeaderUtil").toString().contains("arg1=request map body 'govtIdRequest.*"));
    }
    ...
    private void checkValuesPassedTo_BarcodeRetrieve() {
        ...
        Assertions.assertTrue(exchange.getMessage().getHeader("unitTestBodyBarcodeRetrieve").toString().contains("stepName=start"));
    }

    public void checkAddress_Values(String addressLine1, String addressLine2, String city, String postalCode, String countryCode, String state) {
        Assertions.assertTrue(exchange.getProperty("address").toString().contains("addressLine1=" + addressLine1));
        Assertions.assertTrue(exchange.getProperty("address").toString().contains("addressLine2=" + addressLine2));
        Assertions.assertTrue(exchange.getProperty("address").toString().contains("city=" + city));
        Assertions.assertTrue(exchange.getProperty("address").toString().contains("postalCode=" + postalCode));
        Assertions.assertTrue(exchange.getProperty("address").toString().contains("countryCode=" + countryCode));
        Assertions.assertTrue(exchange.getProperty("address").toString().contains("stateCode=" + state));
    }

    public void checkAddress_areEmptyStrings() {
        checkAddress_Values(",", ",", ",", ",", ",", "}");
    }
    ...
    private void checkProperties_AfterBarcodeRetrieve(barcodeRetrievePropertiesToggle dateToggle) {
        ...
        switch(dateToggle) {
            case GOOD_DATES: Assertions.assertTrue(exchange.getProperty("issueDate").toString().contains(barcodeRetrieve_issueDate));
                ...
                Assertions.assertTrue(exchange.getProperty("replacementDate").toString().contains(barcodeRetrieve_replacementDate));
                break;
            case NULL_FIELDS: Assertions.assertNull(exchange.getProperty("issueDate"));
                Assertions.assertNull(exchange.getProperty("issueStateCode"));
                Assertions.assertNull(exchange.getProperty("expirationDate"));
                Assertions.assertNull(exchange.getProperty("replacementDate"));
                break;
            case NULL_DATES: Assertions.assertNull(exchange.getProperty("issueDate"));
                Assertions.assertTrue(exchange.getProperty("issueStateCode").toString().contains(barcodeRetrieve_issueStateCode));
                Assertions.assertNull(exchange.getProperty("expirationDate"));
                Assertions.assertNull(exchange.getProperty("replacementDate"));
                break;
            case BAD_DATES: Assertions.assertTrue(exchange.getProperty("issueDate").toString().contains(barcodeRetrieve_badDate));
                Assertions.assertTrue(exchange.getProperty("issueStateCode").toString().contains(barcodeRetrieve_issueStateCode));
                Assertions.assertTrue(exchange.getProperty("expirationDate").toString().contains(barcodeRetrieve_badDate));
                Assertions.assertTrue(exchange.getProperty("replacementDate").toString().contains(barcodeRetrieve_badDate));
                break;
        }
    }

    private void checkDates(String dateStatus) {
        Assertions.assertTrue(exchange.getProperty("issueDateValid").toString().contains(dateStatus));
        Assertions.assertTrue(exchange.getProperty("expirationDateValid").toString().contains(dateStatus));
        Assertions.assertTrue(exchange.getProperty("replacementDateValid").toString().contains(dateStatus));
    }

    private void checkValuesPassedTo_DMNGovIdBarcode(String documentStatus, String issueStateCode) {
        Assertions.assertTrue(exchange.getMessage().getHeader("unitTestBodyDmnGovIdBarcode").toString().contains("brTransactionName=account_lookup_1.2_GovIdBarcode.dmn"));
    ...
    private void checkValuesPassedTo_DMNAccountLookup(String dmnType, String expirationDate, String issueDate, String replacementDate) {
        Assertions.assertTrue(exchange.getMessage().getHeader("unitTestBodyDmnAccountLookup").toString().contains("brTransactionName=account_lookup_1.2_AccountLookup" + dmnType + ".dmn"));
        ...
        Assertions.assertTrue(exchange.getMessage().getHeader("unitTestBodyDmnAccountLookup").toString().contains("issueDate=" + issueDate));
        Assertions.assertTrue(exchange.getMessage().getHeader("unitTestBodyDmnAccountLookup").toString().contains("issueDateValid=" + exchange.getProperty("issueDateValid").toString()));
        Assertions.assertTrue(exchange.getMessage().getHeader("unitTestBodyDmnAccountLookup").toString().contains("replacementDate=" + replacementDate));
        Assertions.assertTrue(exchange.getMessage().getHeader("unitTestBodyDmnAccountLookup").toString().contains("replacementDateValid=" + exchange.getProperty("replacementDateValid")));
    ...
    private void checkValuesPassedTo_DMNMatchingStatusCheck(String customerReferenceId, String issueStateCode) {
        Assertions.assertTrue(exchange.getMessage().getHeader("unitTestBodyDmnMatchingStatusCheck").toString().contains("brTransactionName=account_lookup_1.2_MatchingStatusCheck.dmn"));
    ...
    public void testOneCustomer_FullRun(String route, String dmnType, barcodeRetrievePropertiesToggle dateType) throws IOException {
        ...
        // Set up the mocked endpoint responses
        createHeaderUtilMock(headerUtilResponse(post_customerReferenceId));
        ...
        switch (dateType) {
            case GOOD_DATES:
                ...
                break;
            case BAD_DATES:
                createBarcodeRetrieveMock(barcodeRetrieveResponse(barcodeRetrieveResponses.FOUND_ID, barcodeRetrieve_badDate, barcodeRetrieve_badDate, barcodeRetrieve_badDate));
                break;
            case NULL_DATES:
                createBarcodeRetrieveMock(barcodeRetrieveResponse(barcodeRetrieveResponses.NULL_DATES, null, null, null));
                break;
        }
        ...
        switch (dateType) {
            case GOOD_DATES:
                checkProperties_AfterBarcodeRetrieve(barcodeRetrievePropertiesToggle.GOOD_DATES);
                checkDates(dateValid);
                checkValuesPassedTo_DMNAccountLookup(dmnType, barcodeRetrieve_expirationDate, barcodeRetrieve_issueDate, barcodeRetrieve_replacementDate);
                break;
            case BAD_DATES:
                checkProperties_AfterBarcodeRetrieve(barcodeRetrievePropertiesToggle.BAD_DATES);
                checkDates(dateINVALID);
                checkValuesPassedTo_DMNAccountLookup(dmnType, barcodeRetrieve_badDate, barcodeRetrieve_badDate, barcodeRetrieve_badDate);
                break;
            case NULL_DATES:
                checkProperties_AfterBarcodeRetrieve(barcodeRetrievePropertiesToggle.NULL_DATES);
                checkDates(dateNULL);
                checkValuesPassedTo_DMNAccountLookup(dmnType, null, null, null);
                break;
        }
