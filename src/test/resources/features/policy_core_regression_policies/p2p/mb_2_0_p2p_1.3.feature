...
Feature: P2P Component Tests
  ...
  Background:
    ...
    * def URL = URL + '?policyName=mb_2_0_p2p_a&policyVersion=1.3'

  Scenario: Validate Masterbuilder API throws error when invoking P2P Component with shortname
    * call wfResponse { payload: '#(payloads.mb_2_0_p2p_req)', response: '#(responses.mb_2_0_p2p_1dot3_resp)', httpStatus: 404 }
