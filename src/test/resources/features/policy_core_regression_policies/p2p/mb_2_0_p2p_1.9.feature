...
Feature: P2P Component Tests
  ...
  Background:
    ...
    * def URL = URL + '?policyName=mb_2_0_p2p_a&policyVersion=1.9'

  Scenario: Validate cyclic dependency of policy calls
    * call wfResponse { payload: '#(payloads.mb_2_0_p2p_req)', response: '#(responses.mb_2_0_p2p_1dot9_resp)', httpStatus: 200 }
