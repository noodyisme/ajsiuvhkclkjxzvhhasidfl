...
Feature: P2P Component Tests
  ...
  Background:
    ...
    * def URL = URL + '?policyName=mb_2_0_p2p_a&policyVersion=1.16'

  Scenario:Validate policy to policy request from Policy A to Policy B must forward business events automatically
    * call wfResponse { payload: '#(payloads.mb_2_0_p2p_req)', response: '#(responses.mb_2_0_p2p_1dot16_resp)', httpStatus: 200 }
