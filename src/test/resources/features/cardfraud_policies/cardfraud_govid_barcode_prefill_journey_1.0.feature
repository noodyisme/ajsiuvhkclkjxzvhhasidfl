@cardfraud_govid_barcode_prefil_journey_1.0_tag
Feature: Cardfraud GovidbarcodePrefil API integration tests

 ########################### defining requests and responses
  Background:
    * configure headers = req_headers
    * def payloads = read('classpath:config/data/payloads/barcode_prefill/barcode_prefill_1.0_payload.yml')
    * def responses = read('classpath:config/data/responses/barcode_prefill/barcode_prefill_1.0_response.yml')
    ...
    * def URL = URL + '?policyName=barcode_prefill&policyVersion=1.0'

    ###################### Positive Scenario #########################

  @cardfraud_govid_barcode_prefil_journey_1.0_tag1
  ...
  @cardfraud_govid_barcode_prefil_journey_1.0_tag2
  ...
  @cardfraud_govid_barcode_prefil_journey_1.0_tag3
  ...
  @cardfraud_govid_barcode_prefil_journey_1.0_tag4
  ...
  @cardfraud_govid_barcode_prefil_journey_1.0_tag6
  ...
  @cardfraud_govid_barcode_prefil_journey_1.0_tag7
  ...
  @cardfraud_govid_barcode_prefil_journey_1.0_tag8
...
#   @cardfraud_govid_barcode_prefil_journey_1.0_tag9
...
#     * call noWfResponse { payload: '#(payloads.govid_barcode_prefil_journey_emptyBarCode_req)', response: '#(responses.govid_barcode_prefil_journey_emptyBarCode_resp)', httpStatus: 200 }
  ...
  @cardfraud_govid_barcode_prefil_journey_1.0_tag11
  ...
  @cardfraud_govid_barcode_prefil_journey_1.0_tag12
